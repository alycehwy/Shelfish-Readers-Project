        ...
        <table class="table">
            ...
            <?php         
                if($dbConection->connect_error){
                    ...
                    $bookSelect = "SELECT * FROM borrow_tb INNER JOIN books_tb ON borrow_tb.b_id = books_tb.b_id INNER JOIN user_tb ON borrow_tb.buser_id = user_tb.user_id WHERE borrow_tb.status ='borrowing'";
