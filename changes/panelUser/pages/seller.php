<main>
    <form class='addbook' method="POST" action="<?php $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data">
        ...
        <input class='descrip' name="productDetails" placeholder="Enter product description" required/>
        <input class='browse' name="bImg" type="file" required/>
